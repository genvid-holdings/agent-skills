...
The declaration and the bytes are reconciled, not merged. Where they disagree —
the declaration says captured, the file's own metadata names a model — the scan
